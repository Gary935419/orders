			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					...
					<div class="layui-upload-list">
						<input type="hidden" name="gimg" value="<?php echo $limg ?>" id="gimg" lay-verify="gimg" autocomplete="off"
							   class="layui-input">
						<img class="layui-upload-img" src="<?php echo $limg ?>" style="" id="gimgimg" name="gimgimg">
						<p id="demoText"></p>
					</div>
										<span style=" color: #CC0000">*图片像素建议为：180px*50px </span>
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label" style="width: 30%;">
