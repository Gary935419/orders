...
<style>
	.textpdf{height: 25px; line-height: 25px;border-style: none; background-color:#f1f1f1; width: 70%};
</style>
<body>
<div class="layui-fluid" style="padding-top: 50px;">
	<div class="layui-row">
					...
					<div style="width: 600px" class="layui-input-inline layui-show-xs-block">
						<select name="username" id="username" lay-verify="username">
							<?php foreach ($userlist as $num => $nlist): ?>
								<option value="<?=$nlist['mid'];?>" <? if($orderlsit['mid']==$nlist['mid']){echo 'selected';}?>><?=$nlist['company_name'];?>-<?=$nlist['truename'];?></option>
							<? endforeach;?>
						</select>
					</div>
				</div>
					...
					<div style="width: 600px" class="layui-input-inline layui-show-xs-block">
						<select name="proclass" id="proclass" lay-verify="proclass">
							<?php foreach ($proclasslist as $num => $plist): ?>
								<option value="<?=$plist['pid'];?>" <? if($orderlsit['product_class_name']==$plist['pid']){echo 'selected';}?>><?=$plist['product_class_name'];?></option>
							<? endforeach;?>
						</select>
					</div>
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 70%;">
					<input type="text" id="productnum" name="productnum" lay-verify="productnum"
						   autocomplete="off" class="layui-input" placeholder="0" value="<?=$orderlsit['quantity_purchased'];?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
				...
				<div class="layui-input-inline" style="width: 70%;">
					<input id="gettime" name="gettime" lay-verify="gettime"
						   autocomplete="off" class="layui-input" value="<?=date("Y-m-d",$orderlsit['purchasing_time']);?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
				...
				<div class="layui-input-inline" style="width: 70%;">
					<input id="stoptime" name="stoptime" lay-verify="stoptime"
						   autocomplete="off" class="layui-input" value="<?=date("Y-m-d",$orderlsit['end_time']);?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
				...
				<div class="layui-input-inline" style="width: 70%;">
					<input type="text" id="caddress" name="caddress"
						   autocomplete="off" class="layui-input" value="<?=$orderlsit['product_caddress'];?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
				...
				<div class="layui-input-inline" style="width: 70%;">
					<input type="text" id="jaddress" name="jaddress"
						   autocomplete="off" class="layui-input" value="<?=$orderlsit['product_jaddress'];?>">
				</div>
			</div>
			<div class="layui-form-item">
				<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
			...
			<? if(trim($orderlsit['product_specification1'])){?>
				<div class="layui-form-item">
					<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
						<span class="x-red"></span>说明文件1（pdf）：
					</label>
					<div class="layui-input-inline" style="width: 70%;">
						<form method="get" action="<?=$orderlsit['product_specification1'];?>">
							<button type="submit" class="layui-btn">文件下载</button>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="text" readonly id="pdfurl" name="pdfurl" autocomplete="off" class="textpdf" value="<?=$orderlsit['product_specification1'];?>">&nbsp;
						</form>
					</div>
				</div>
			<? }?>
			<? if(trim($orderlsit['product_specification2'])){?>
				<div class="layui-form-item">
					<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
						<span class="x-red"></span>说明文件2（pdf）：
					</label>
					<div class="layui-input-inline" style="width: 70%;">
						<form method="get" action="<?=$orderlsit['product_specification2'];?>">
							<button type="submit" class="layui-btn">文件下载</button>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="text" readonly id="pdfurl" name="pdfurl" autocomplete="off" class="textpdf"  value="<?=$orderlsit['product_specification2'];?>">&nbsp;
						</form>
					</div>
				</div>
			<? }?>
			<? if(trim($orderlsit['product_specification3'])){?>
				<div class="layui-form-item">
					<label for="L_pass" class="layui-form-label" style="width: 20%; font-size: 14px">
						<span class="x-red"></span>说明文件3（pdf）：
					</label>
					<div class="layui-input-inline" style="width: 70%;">
						<form method="get" action="<?=$orderlsit['product_specification3'];?>">
							<button type="submit" class="layui-btn">文件下载</button>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="text" readonly id="pdfurl" name="pdfurl" autocomplete="off" class="textpdf" placeholder="文件大小不能超过10M" value="<?=$orderlsit['product_specification3'];?>">&nbsp;
						</form>
					</div>
				</div>
			<? }?>
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 70%;">
						<textarea placeholder="" id="desc" name="desc" class="layui-textarea"
								  lay-verify="jianyi"><?=$orderlsit['product_desc'];?></textarea>
				</div>
			</div>
			<div class="layui-form-item">
