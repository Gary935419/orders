			...
			<div class="layui-form-item layui-form-text">
				...
				<table class="layui-table layui-input-block">
					...
					<tr>
						...
						<td>
							<input name="menu[]" lay-skin="primary" type="checkbox" value="3" title="模块1"
								   lay-verify="check" lay-filter="father">
						</td>
					</tr>
					<tr>
						<td>
							<input name="menu[]" lay-skin="primary" type="checkbox" value="4" title="模块2"
								   lay-verify="check" lay-filter="father">
						</td>
						<td>
							<input name="menu[]" lay-skin="primary" type="checkbox" value="5" title="模块3"
								   lay-verify="check" lay-filter="father">
						</td>
						<td>
							<input name="menu[]" lay-skin="primary" type="checkbox" value="6" title="模块4"
								   lay-verify="check" lay-filter="father">
						</td>
					</tr>
					<tr>
						<td>
							<input name="menu[]" lay-skin="primary" type="checkbox" value="7" title="模块5"
								   lay-verify="check" lay-filter="father">
						</td>
						<td>
							<input name="menu[]" lay-skin="primary" type="checkbox" value="8" title="模块6"
								   lay-verify="check" lay-filter="father">
						</td>
					</tr>
					</tbody>
